          ...
          <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {renderDato("Última Fecha", formatDate(machine?.[0].UltFecha))}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {renderDato("Estado Operativo", machine?.[0].idestadooperativo)}
                {renderDato("Estado de Traslado", machine?.[0].traslado_state)}
                ...
                {renderDato("Subcategoría", machine?.[0].idsubcategoriamaquina)}
              </div>
            </section>
          </div>
        )}
